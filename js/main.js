...
let layerTexture_0 = new THREE.TextureLoader().load('../imgs/fg.png');
...
let layerTexture_1 = new THREE.TextureLoader().load('../imgs/band_0.png');
...
let layerTexture_2 = new THREE.TextureLoader().load('../imgs/band_1.png');
...
let layerTexture_3 = new THREE.TextureLoader().load('../imgs/band_2.png');
...
let layerTexture_4 = new THREE.TextureLoader().load('../imgs/band_3.png');
...
let layerTexture_5 = new THREE.TextureLoader().load('../imgs/band_4.png');
